...
public class MessageManagement {
	...
	public static HashMap<String,BufferedReader> playerInChannels = new HashMap<>();
	...
	synchronized public static void singleChar(String sendId,String receiveId,String message) {
		...
		receiveOut.println("@"+sendId+"戳了你一下:\n"+message);
		receiveOut.flush();
	}
	//群聊
	public static void groupChat(Player player) throws Exception {
		...
		for (String string : ids) {
			...
			pStream.println("@"+player.getId()+"戳了你一下:\n"+message);//群发
			pStream.flush();
		}
